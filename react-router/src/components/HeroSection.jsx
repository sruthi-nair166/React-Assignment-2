function HeroSection() {
  return (
    <div className="h-[90dvh] flex flex-col text-center justify-center items-center gap-10">
      <h1 className="text-5xl w-3/4 mb-5 text-sky-900">
        Welcome to the Corporate Portal. Manage your team and view department
        analytics.
      </h1>

      <div className="flex justify-center w-1/2 border-2 border-sky-800 rounded-3xl p-1">
        <input
          type="text"
        ...
        />
        <button className="bg-sky-500 hover:bg-sky-600 transition text-white rounded-2xl ms-1 px-5 py-0.5">
          Search
        </button>
      </div>
    </div>
